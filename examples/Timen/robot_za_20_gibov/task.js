function initTask(subTask) {
    subTask.gridInfos = {				//podatki za urejevalnik in vizualno okno
		...
		itemTypes: {
			robot0: { img: ["robot_8pogledov.png"], side: 60, nbStates: 8, zOrder: 8, category: {'robot': true}, },
			obstacle: { num: 2, img: "dirt.png", zOrder: 1, category: {'obstacle': true}},
			coin :{ num:3,img:["finish_transparent.png"],side: 60,zOrder: 2, category:{"coin":true}},
		}, 
