function initTask(subTask) {
    subTask.gridInfos = {				//podatki za urejevalnik in vizualno okno
		...
		itemTypes: {
			robot: { img: ["pisek_all_8_sides.png"], side: 60, nbStates: 8, zOrder: 8, category: {'robot': true}, },
			coin1: { num:3, img:["bus.png"],zOrder: 2, category:{"coin":true}},
			coin2: { num:4,img:["train.png"],side: 60, nbStates: 8,zOrder: 8, category:{"coin":true}},
		}, 
