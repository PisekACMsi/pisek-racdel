function initTask(subTask) {
    subTask.gridInfos = {				//podatki za urejevalnik in vizualno okno
		...
		itemTypes: {
			...
			snowflake: { num: 4, img: "Snowflake_transparent.png", zOrder: 2, category:{"snowflake":true}},
			red_flag: { num: 5, img: "Red_flag_transparent.png", zOrder: 2, category: {"colour":true, "transportable":true}, colour:"red"},
			blue_flag: { num: 6, img: "Blue_flag_transparent.png", zOrder: 2, category: {"colour":true, "transportable":true}, colour:"blue"},
		}, 
		...
		easy: [
			{
			   ...
			   initItems: [
					 { row: 2, col: 2, dir: 0, type: "robot0", dir:0},
				  ]
			},
